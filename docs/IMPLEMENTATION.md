...
## Current handoff state · September 5, 14:33 UTC
...
- **Source:** version 0.2.10, frozen tree `0b65ec644b8ddbb48df4f02c773efc5fc39cd356` on `codex/wanikani`. Its exact frozen runtime passed 1125 Python tests in 219.751 seconds, with one opt-in audio-device check skipped, plus 126 core Qt checks. Manifest is valid; 42 runtime QML files lint with zero errors and 566 retained warnings. See [verification](VERIFICATION.md) for exact trees, archive paths, captures and scope.
