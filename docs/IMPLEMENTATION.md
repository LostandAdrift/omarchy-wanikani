...
- 303 Python tests passed, including 12 original subprocess crash boundaries and four milestone transaction interruptions. 61 Qt kana/desktop-policy/activation/glyph checks passed. Manifest and both installed desktop launchers validate; Hyprland has no configuration errors.
