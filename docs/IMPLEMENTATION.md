...
## Current handoff state · September 5, 15:03 UTC
...
- **Source:** version 0.2.11, frozen tree `96248694da0c0b33bbfa2ac9161c7cb5d07633d3` on `codex/wanikani`. Its exact frozen runtime passed 1127 Python tests in 225.155 seconds, with one opt-in audio-device check skipped, plus 126 core Qt checks. Manifest is valid; 43 runtime QML files lint with zero errors and 566 retained warnings. See [verification](VERIFICATION.md) for exact trees, archive paths, captures and scope.
