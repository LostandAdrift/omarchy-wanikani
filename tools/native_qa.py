...
REQUIRED_RUNTIME = ("manifest.json", "Service.qml", "Panel.qml", "backend/worker.py",
    ...
    "backend/wanikani/srs_explorer.py", "qml/SrsExplorer.qml",
    ...
    "qml/Listening.qml", "qml/StudyOverview.qml", "qml/StudyRhythm.qml", "qml/TodayLevel.qml", "qml/TodayActivity.qml", "qml/SubjectPath.qml", "qml/SubjectStatus.mjs")
