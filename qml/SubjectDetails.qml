...
ColumnLayout {
  ...
  ColumnLayout {
    ...
    Ui.TextField {
      ...
      text: root.subject ? (root.subject.material.meaning_synonyms || []).join(", ") : ""
    ...
    Controls.TextArea {
      ...
      text: root.subject ? root.subject.material.meaning_note || "" : ""
    ...
    Controls.TextArea {
      ...
      Layout.fillWidth: true
      Layout.preferredHeight: Style.space(90)
      text: root.subject ? root.subject.material.reading_note || "" : ""
    ...
    Action {
      ...
      enabled: !root.controller.busy && root.subject && !root.subject.material_pending
      onClicked: root.controller.call("set_material", {
        subject_id: root.subject.id,
        values: {
          meaning_synonyms: synonyms.text.split(",").map(function (s) {
            return s.trim()
          }).filter(function (s) {
            return s.length > 0
          }),
