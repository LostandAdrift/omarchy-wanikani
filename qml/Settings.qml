...
ColumnLayout {
  ...
  property string section: snapshot.connected || snapshot.demo ? "study" : "account"
  readonly property var sectionNames: ["account", "study", "audio", "reminders", "desktop", "storage", "data"]
  ...
  function focusInput() {
    if (!active)
      return
    var target = section === "account" && !snapshot.demo ? token : section === "study" ? batchSizeField.field : firstControl(sectionItem(section))
    if (target && target.visible && target.enabled)
      target.forceActiveFocus(Qt.OtherFocusReason)
  }
  function selectSection(name) {
    if (sectionNames.indexOf(name) < 0 || !active)
      return
    section = name
    var selected = name
    Qt.callLater(function () {
      if (root.active && root.section === selected)
        root.focusInput()
    })
  }
  Label {
  ...
  Flow {
    objectName: "settings-section-navigation"
    ...
    Repeater {
      ...
      Action {
        ...
        accessibleHint: "Show " + modelData.label.toLowerCase() + " settings."
  ...
  ColumnLayout {
    id: accountSection
    objectName: "settings-group-account"
    Layout.fillWidth: true
    ...
    ColumnLayout {
      ...
      Controls.CheckBox {
        objectName: "settings-remember-token"
  ...
  ColumnLayout {
    id: studySection
    objectName: "settings-group-study"
    Layout.fillWidth: true
    visible: root.section === "study"
    spacing: Style.space(14)
    Label {
      text: "Study"
      font.bold: true
  ...
  ColumnLayout {
    id: audioSection
    objectName: "settings-group-audio"
    Layout.fillWidth: true
    visible: root.section === "audio"
    spacing: Style.space(14)
    VoiceChoices {
      id: voiceChoices
      objectName: "settings-voices"
      Layout.fillWidth: true
  ...
  ColumnLayout {
    id: remindersSection
    objectName: "settings-group-reminders"
    Layout.fillWidth: true
    visible: root.section === "reminders"
    spacing: Style.space(14)
    StudyRhythm {
      id: studyRhythm
      Layout.fillWidth: true
  ...
  ColumnLayout {
    id: desktopSection
    objectName: "settings-group-desktop"
    Layout.fillWidth: true
  ...
  ColumnLayout {
    id: storageSection
    objectName: "settings-group-storage"
    Layout.fillWidth: true
  ...
  ColumnLayout {
    id: dataSection
    objectName: "settings-group-data"
    Layout.fillWidth: true
    ...
    ColumnLayout {
      ...
      Controls.CheckBox {
        objectName: "settings-discard-pending"
